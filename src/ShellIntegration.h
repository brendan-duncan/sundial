...
// Register HKCU shell verbs so right-clicking the HDR image formats Sundial can
// re-open (.jxr, .avif) in Explorer shows "Open with Sundial". Idempotent -
// safe to call on every launch. Path should be the absolute path to the
// currently running sundial.exe. Windows 11 shows third-party verbs under
// "Show more options".
